...
const Create = () => {
  ...
  return (
    <div className="h-screen w-screen bg-black text-white flex items-center justify-center bg-no-repeat bg-cover">
      <div className="h-[500px] w-[500px] border rounded-lg p-5 px-20 ">
        <div className="text-center mt-14">
          <h1 className="text-5xl font-bold">DocWave </h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col mt-3">
          <div className="text-start">
            <p className="text-lg text-bold mt-5 text-[#B5BAC1]">Document Title</p>
            <input
              type="text"
              value={title}
